		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Booking UI5",
									"targetURL": "#convistaflightbookingui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"convistaflightbookingui5-display": {
								"semanticObject": "convistaflightbookingui5",
								"action": "display",
								"description": "Booking Collection application SAP UI5.",
								"title": "Flight Booking UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=convista.flightbookingui5",
									"url": sap.ui.require.toUrl("convista/flightbookingui5")
								}
							}
						}
					}
